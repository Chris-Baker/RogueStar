...
public class PhysIntersector {
     ...
     * @return
     */
    public static boolean overlapConvexPolygonsSweep (Polygon polygonA, float vx, float vy, Polygon polygonB, MinimumTranslationVector mtv) {

        float[] verts1 = polygonA.getTransformedVertices();
        float[] verts2 = polygonB.getTransformedVertices();
        int offset1 = 0;
        int offset2 = 0;
